                            ...
                            <div class="upload">
                                <div class="upload__item">
                                    ...
                                    <div class="upload__raw">
                                        <input id="upload_picture" type="file" name="upload" class="upload__field-file"><span class="upload__field"><?=t('Загрузите изображение')?></span>
                                ...
                                <div class="upload__item">
                                    ...
                                    <div class="upload__raw">
                                        <input id="upload_watermark" type="file" name="upload" class="upload__field-file"><span class="upload__field"><?=t('Загрузите изображение')?></span>
                                        <button class="upload__button"></button>
                                    </div>
                                </div>
                            </div>
